...
@Component({
  selector: 'app-cost-search-component',
  templateUrl: './cost-search-component.component.html',
  styleUrls: ['./cost-search-component.component.less']
})
export class CostSearchComponentComponent implements OnInit {
