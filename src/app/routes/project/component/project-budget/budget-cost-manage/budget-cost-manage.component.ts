...
@Component({
  selector: 'app-budget-cost-manage',
  templateUrl: './budget-cost-manage.component.html',
  styles: [`
    .cost-val {
      display: inline-block;
      width: 120px;
    }
    .modal-form nz-form-label{
      width: 120px;
    }
    .modal-form nz-form-control{
      flex-grow: 1;
    }
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => BudgetCostManageComponent),
      multi: true
    },
    {
...
export class BudgetCostManageComponent implements ControlValueAccessor {
  costCategoryArr:any[] = [];
