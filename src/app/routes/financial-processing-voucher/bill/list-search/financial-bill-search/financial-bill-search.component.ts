...
@Component({
  selector: 'app-financial-bill-search',
  templateUrl: './financial-bill-search.component.html',
  styles: [
  ]
})
export class FinancialBillSearchComponent implements OnInit {
  ...
  searchOptionsChange(option?: any) {
    ...
    if (this.list.length !== 0) {
      ...
      console.log('已开发票: ', this.listOfData);
    }
  }
