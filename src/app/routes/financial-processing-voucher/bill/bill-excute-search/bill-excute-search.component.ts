...
@Component({
  selector: 'app-bill-excute-search',
  templateUrl: './bill-excute-search.component.html',
  styles: [
  ]
})
export class BillExcuteSearchComponent implements OnInit {
  ...
  billList(option) {
    ...
    this.settingsConfigService.post('/api/bill/execute/list', option).subscribe((res: ApiData) => {
