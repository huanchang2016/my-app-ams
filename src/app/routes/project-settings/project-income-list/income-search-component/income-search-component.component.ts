...
@Component({
  selector: 'app-income-search-component',
  templateUrl: './income-search-component.component.html',
  styleUrls: ['./income-search-component.component.less']
})
export class IncomeSearchComponentComponent implements OnInit {
