...
@Component({
  selector: 'app-my-bill-search',
  templateUrl: './my-bill-search.component.html',
  styles: [
  ]
})
export class MyBillSearchComponent implements OnInit {
  ...
  billList(option) {
    ...
    this.settingsConfigService.post('/api/bill/my', option).subscribe((res: ApiData) => {
