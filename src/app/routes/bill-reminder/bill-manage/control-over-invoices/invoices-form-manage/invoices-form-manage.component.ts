...
@Component({
  ...
  styles: [
    `
      ...
      :host ::ng-deep .show_info_box .sv__label,
      :host ::ng-deep .show_info_box .sv__detail {
        line-height: 36px;
        padding-bottom: 0;
      }
    `,
...
export class InvoicesFormManageComponent implements OnInit {
  ...
  create() {
    ...
    const option: any = {
      ...
      tax_id: this.income_type === 'project' ? opt.project_tax_id : null,
      subsidy_income_detail_id: this.income_type === 'subsidy' ? opt.subsidy_tax_id : null,
      remark: opt.remark,
      amount: opt.amount,
  ...
  setFormValue(data: any): void {
    ...
    console.log(this.income_type, this.projectTaxList, this.subsidyTaxList, '...............');
