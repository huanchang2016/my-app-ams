...
export class PaymentContractFormComponent implements OnInit {
  ...
  create() {
    ...
    console.log(opt);
    this.settingConfigService.post('/api/cost/category/create', opt).subscribe((res:ApiData) => {
      console.log(res);
  ...
  edit() {
    ...
    this.settingConfigService.post('/api/cost/category/update', obj).subscribe((res:ApiData) => {
      console.log(res);
      this.submitLoading = false;
      if(res.code === 200) {
  ...
  getContractTreatyList(id:number) {
    ...
    zip(
      this.settingConfigService.post(`/api/contract/supplier`, opt),
      this.settingConfigService.post(`/api/treaty/supplier`, opt)
