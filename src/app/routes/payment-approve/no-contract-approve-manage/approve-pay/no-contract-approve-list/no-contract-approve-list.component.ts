...
@Component({
  selector: 'app-no-contract-approve-list',
  templateUrl: './no-contract-approve-list.component.html',
  styles: []
})
export class NoContractApproveListComponent implements OnInit {
  ...
  getDataList() {
    this.loading = true;
    this.settingConfigService.get('/api/treaty/pay/approval/my', this.pageOption).subscribe((res:ApiData) => {
      console.log('协议支付信息，该我审批得：', res);
