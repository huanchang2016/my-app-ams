...
@Component({
  selector: 'app-in-approve-project',
  templateUrl: './in-approve-project.component.html',
  styles: []
})
export class InApproveProjectComponent implements OnInit {
  // 单位id
  ...
  getDataList() { // 获取单位下的数据
    this.loading = true;
    this.settingConfigService.get('/api/contract/pay/approval/my', this.pageOption).subscribe((res:ApiData) => {
