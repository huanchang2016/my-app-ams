...
@Component({
  selector: 'app-no-contract-apply-refuse',
  templateUrl: './no-contract-apply-refuse.component.html',
  styles: []
})
export class NoContractApplyRefuseComponent implements OnInit {
  ...
  getDataList() {
    this.loading = true;
    this.settingConfigService.get('/api/treaty/pay/refuse/my', this.pageOption).subscribe((res:ApiData) => {
      console.log('协议支付信息，未通过：', res);
