...
@Component({
  selector: 'app-apply-excute-search',
  templateUrl: './apply-excute-search.component.html',
  styles: [
  ]
})
export class ApplyExcuteSearchComponent implements OnInit {
  ...
  listRequest(option) {
    ...
    this.settingsConfigService.post('/api/contract_pay/execute/list', option).subscribe((res: ApiData) => {
