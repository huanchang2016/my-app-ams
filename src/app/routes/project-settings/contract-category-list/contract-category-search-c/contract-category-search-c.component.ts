...
@Component({
  selector: 'app-contract-category-search-c',
  templateUrl: './contract-category-search-c.component.html',
  styleUrls: ['./contract-category-search-c.component.less']
})
export class ContractCategorySearchCComponent implements OnInit {
